...
> **Статус: прогон запущен 2026-07-29 21:00 UTC.** Все 16 монет пишутся на HL, все 16 UM-зеркал на
> обоих UM-инстансах (BTC/ETH/SOL как референс режима — только на первичном), 15 из 16 на Lighter
> (INJ не листингован). SEI/TIA/ENA/xyz:GOLD и XAUUSDT из записи убраны. Окно 10–14 дней
...
> **Инструмент готов (2026-07-30):** `collector/tools/rerank_metrics.py` считает пп. 1–5 по сырым
> записям (65 тестов, интегральная арифметика цен, конвенция знака lead-lag закреплена тестом).
> Калибровка по известным инструментам сошлась: HYPE — 81.5% сессии ровно в 1 тик, PUMP зажат,
> JTO — p50 16 тиков и 90.6% сессии ≥3 тиков; Binance ведёт на 450–800 мс на всём замеренном.
> Первые полные дни нового набора — с 20260730; переранжирование (п. 6) — после 10–14 дней.
